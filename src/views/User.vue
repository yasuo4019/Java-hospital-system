<template>
  <div>
    <div style="padding: 10px 0">
      <el-input style="width: 230px" placeholder="Enter Name" suffix-icon="el-icon-search" class="ml-5" v-model="username"></el-input>
      <el-input style="width: 230px" placeholder="Enter Email" suffix-icon="el-icon-message" class="ml-5" v-model="email"></el-input>
      <el-input style="width: 230px" placeholder="Enter Address" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload
          action="https://localhost:9090/user/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
        <el-button type="primary" class="ml-5">Import<i class="el-icon-bottom"></i></el-button>
      </el-upload>
      <el-button type="primary" class="ml-5" @click="exp">Export<i class="el-icon-top"></i></el-button>
    </div>
...
export default {
  ...
  methods : {
    ...
    exp() {
      window.open("https://localhost:9090/user/export")
    },
